  ...
  switch (method) {
      case "POST":
        ...
        try {
          ...
          //   // },
          //   url: "https://wapp.callindex.co.il/c2c/open_numbers.php",
          //   auth: {
          //     username: "rutw@harel-ins.co.il",
          //     password: "Harel7946",
          //   },
          //   method: 'post',
          //   data: {
          //     uberId: '3613',
          //     phone_number: "033818324",
          //     prefix: body.phoneNumber,
          //   },
          // }
          ...
          formdata.append("prefix", "972524453255");
          ...
          const Response = await fetch("https://wapp.callindex.co.il/c2c/open_numbers.php", requestOptions)
          if (Response) {
            res.status(200).end(`activated number successfuly: ${body.phoneNumber}`);
          }
